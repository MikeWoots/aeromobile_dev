  ...
  downloadTiles(tileUrls, boundaryId) {
    this.platform.ready().then(() => {
      ...
      const downloadTile = (urlExtension) => () => new Promise((resolve, reject) => {
        const url = 'orchard-' + urlExtension;
